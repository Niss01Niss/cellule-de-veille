...
import { Shield, BarChart3, Search, X, Target, Menu, Home, Settings, HelpCircle } from 'lucide-react'
      ...
      <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
        <div className="flex items-center space-x-3">
          <div className="relative">
            <Shield className="h-10 w-10 text-blue-600 drop-shadow-sm" />
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 font-medium">Dashboard Sécurité</p>
          </div>
        </div>
        {isMobile && onClose && (
          <button
            onClick={onClose}
            className="p-2 rounded-lg bg-white/50 hover:bg-white/80 transition-all duration-200 shadow-sm hover:shadow-md"
          >
      ...
      <nav className="p-4 space-y-2">
                  ...
                  `}>
                    ...
                    <div className="flex-1">
                      ...
                      <p className={`text-xs transition-all duration-200 ${
                        item.active ? 'text-blue-100' : 'text-gray-400 group-hover:text-blue-500'
                      }`}>
                        {item.description}
                      </p>
                    </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <div className="space-y-1">
            <div className="group px-4 py-3 rounded-xl cursor-pointer transition-all duration-200 hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <span className="font-medium text-gray-700 group-hover:text-blue-600 transition-all duration-200">
                    Guide d'utilisation
                  </span>
                  <p className="text-xs text-gray-400 group-hover:text-blue-500 transition-all duration-200">
...
const Sidebar = ({ isOpen, onClose }) => {
  return (
    <>
      ...
      {/* Sidebar desktop */}
      <div className="hidden lg:block fixed top-0 left-0 h-full w-72 bg-white shadow-2xl z-50 border-r border-gray-200/50 backdrop-blur-sm">
        <SidebarContent />
      </div>
      ...
      <div className={`
        ...
        w-80 border-r border-gray-200/50 backdrop-blur-sm
      `}>
